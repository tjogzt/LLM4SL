...
\toprule
\textbf{Method} & \textbf{CV1 AUC} & \textbf{CV3 AUC} & \textbf{CV3 NDCG@10} & \textbf{CV3 AUPRC} & \textbf{SL Adj.} \\
\midrule
SLMGAE (standard) & 0.903 $\pm$ 0.010 & 0.907 & 0.909 & --- & Incl. test pairs \\
SLMGAE (fair) & 0.903 $\pm$ 0.010 & 0.770 $\pm$ 0.032 & 0.898 $\pm$ 0.089 & --- & Masked \\
Ours (text+PPI) & 0.693 $\pm$ 0.107 & 0.697 $\pm$ 0.117 & 0.579 $\pm$ 0.102 & 0.472 & No SL adj. \\
Ours (+ESM-2) & 0.862 $\pm$ 0.025 & --- & --- & --- & Seq. priors \\
\bottomrule
\end{tabular}
\end{table}
